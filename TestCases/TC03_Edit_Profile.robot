...
TC03
    ...
    # Start Video Recording    name=D:/TestCoffee496/Testdata/TC03_EditProfile  fps=None    size_percentage=1   embed=True  embed_width=100px   monitor=1
    Open Excel Document    D:/TestCoffee496/Testdata/TC03_EditProfile.xlsx    doc_id=TestData
    ...
    END
    Close All Browsers
    Save Excel Document    D:/TestCoffee496/ResultsData/TD03_Editprofile_Result.xlsx
