...
TC01
    ...
    # Start Video Recording    name=D:/TestCoffee496/Testdata/TC01_Login  fps=None    size_percentage=1   embed=True  embed_width=100px   monitor=1
    ...
    Save Excel Document    D:/TestCoffee496/ResultsData/TD01_Login_Result3.xlsx
