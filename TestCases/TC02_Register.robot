...
TC02
    ...
    # Start Video Recording    name=D:/TestCoffee496/Testdata/TC02_Register  fps=None    size_percentage=1   embed=True  embed_width=100px   monitor=1
    Open Excel Document    D:/TestCoffee496/Testdata/TC02_Register.xlsx    doc_id=TestData
    ...
    FOR    ${i}    IN RANGE    2    ${excel.max_row+1}
        ...
        END
    END
    Save Excel Document    D:/TestCoffee496/ResultsData/TD02_Register_Result.xlsx
